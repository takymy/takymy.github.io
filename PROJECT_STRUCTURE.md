...
- **`_data/`**
  This folder acts as your database. It contains YAML (`.yml`) files listing your skills, projects, experience, achievements, etc. By keeping data here, your HTML files stay clean, and you can easily loop through the data (e.g., `{% raw %}{% for project in site.data.projects %}{% endraw %}`).
